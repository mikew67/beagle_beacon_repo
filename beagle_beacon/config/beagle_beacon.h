/*	This file is a modified version of the Nordic pca20006.h hardware 
*	configuration file, to suit the Beagle Beacon.
*	Mike Wirth, Dec., 2015
* **************************************************************************
 ...
 *
 */
#ifndef BEAGLE_BEACON_H
#define BEAGLE_BEACON_H

// LEDs and buttons definition for Beagle Beacon board
// Note: There is no LED on the board, but a MOSFET driver and two test points 
// for connecting a test LED
